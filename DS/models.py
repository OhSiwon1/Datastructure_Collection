...
class Project(models.Model):
    ...
    uploadedFile = models.FileField(upload_to="zipfile/")
    ...
    poster=models.FileField(upload_to="paperfile/",blank=True)
    repoter=models.FileField(upload_to="repoter/",blank=True,null=True)
